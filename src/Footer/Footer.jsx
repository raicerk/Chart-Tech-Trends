  ...
  return (
    <div className="footer">
      <ul className="footer__resources">
        ...
        <li>Foto de <a href="https://unsplash.com/@schwiet?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Seth Schwiet</a> descargada de <a href="/?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Unsplash</a></li>
      </ul>     
    </div>
  );
}
