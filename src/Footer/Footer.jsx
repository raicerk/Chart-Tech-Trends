  ...
  return (
    <div className="footer">
      <ul className="footer__resources">
        <li>Código de FrontEnd en <a href="https://github.com/raicerk/Chart-Tech-Trends" target="_blank" rel="noopener noreferrer">Chart-Tech-Trends</a></li>
        <li>Código de Backend en <a href="https://github.com/pgramadores/LaboralGraphQL" target="_blank" rel="noopener noreferrer">LaboralGraphQL</a></li>
